...
import com.yyf.www.luojia.service.SecurityAccessDecisionManager;

/**
 * @Description: TODO
 * @author yyf
 * @date 2018年3月26日 下午9:17:10
 * @version 1.0
 */
@Service
public class SecurityInterceptorFilter extends AbstractSecurityInterceptor implements Filter {
	...
	@Autowired
	public void setUrlAccessDecisionManager(SecurityAccessDecisionManager urlAccessDecisionManager) {
